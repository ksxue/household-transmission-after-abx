...
dataFixedDiffsSharing <- 
  read.table("workflow/analysis/identifySharedStrains-fixedDiffs/out/fixedDiffs-sharingAnnotated.txt.gz",
...
dataStrainFishingSharing <-
  read.table("workflow/analysis/identifySharedStrains-strainFishing/out/strainFishing-sharingAnnotated.txt.gz",
             header=TRUE, stringsAsFactors = FALSE)
...
write.table(dataSharedStrainsConsolidated,
            paste0(OUTDIR, "strainSharingCalls-consolidated.txt"),
